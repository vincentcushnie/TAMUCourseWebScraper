...
class Functions {
    public:
        ...
        static void degreeInformationProcessAndScrape(pugi::xml_document& doc, int id, std::string url);
        ...
        static void processCourseTables(pugi::xml_node &node_2, std::vector<std::string>& courseSuperscripts, std::vector<std::string> &data, const int &majorID, int &credits);
